  ...
  return (
    <UIContext.Provider
      value={{
        ...
        toggleSlideOversFormComponent: { value: valueSlideOversComponent, actions: actionsSlideOversComponent },
...
export const useUI = () => {
  const {toggleSlideOversCarts, toggleMenu, toggleSearch, toggleSlideOversForm, toggleSlideOversFormArticle, toggleSlideOversFormComponent, childrenDashboard} = useContext(UIContext)
  return {
    toggleSlideOversCarts, toggleMenu, toggleSearch, toggleSlideOversForm, toggleSlideOversFormArticle, toggleSlideOversFormComponent, childrenDashboard
  }
}